  ...
  dialog.showMessageBox(
    {
      ...
      message:
        "A new version of Padlock is available! Do you want to install it now?",
    ...
    (buttonIndex) => {
      if (buttonIndex === 0) {
        ...
        dialog.showMessageBox({
          ...
          type: "info",
          message:
            "The new version is being downloaded. You'll be notified when it is ready to be installed!"
        });
      }
    }
  );
  ...
  win.loadURL(
    url.format({
      pathname: path.resolve(
        __dirname,
        test ? "test/index.html" : "app/index.html"
      ),
      protocol: "file:",
      slashes: true
    })
