$l.loadTranslations({
  en: {
    ...
    "Upgrade to enable synchronization!": "",
    "{0} Devices Connected": "",
    Billing: "",
    "Cancel Subscription": "",
    "Padlock Online": "",
    ...
    "Check your inbox! An email was sent to **{0}** containing your login code.":
      "",
    Cancel: "",
    "Please enter the master password for the account **{0}**!": "",
    ...
    "For security reasons don't keep a record of your master password so unfortunately we cannot help you recover it. You can reset your password, but your data will be lost in the process!":
      "",
    "Reset Password": "",
    "Keep Trying": "",
    "Forgot Your Password?": "",
    "Are you sure you want to reset your password? WARNING: All your data will be lost!":
      "",
    Submit: "",
    "Successfully updated the password for your account {0}.": "",
    "Failed to update password. Please try again later!": "",
    "You successfully paired this device with Padlock Cloud!": "",
    "Synchonize Now": "",
    "Check your email! We sent your login code to {0}.": "",
    "Invalid login code. Try again!": "",
    Login: "",
    "Please enter a valid email address!": "",
    "Log in now to unlock advanced features like automatic online backups and seamless synchronization between devices!":
      "",
    "Your trial period ends in {0} days. Upgrade now to continue using online features like synchronization and automatic backups!":
      "",
    "Your free trial has expired. Upgrade now to continue using advanced features like automatic online backups and seamless synchronization between devices!":
      "",
    "Your last payment has failed. Please contact your card provider or update your payment method!":
      "",
    "Your subscription has been canceled. Reactivate it now to continue using advanced features like automatic online backups and seamless synchronization between devices!":
      "",
    "This device is connected to the Padlock Cloud account {0}. Connect all your devices with the same account to easily synchronize your data between them!":
      "",
    "The master password you use locally does not match the one of your online account {0}. What do you want to do?":
      "",
    "Update Local Password": "",
    "Update Online Password": "",
    "Keep Both Passwords": "",
    ...
    "For security reasons only a limited amount of connection request are allowed at a time. Please wait a little before trying again!":
      "",
    "You've been logged out of your Padlock online account. Please login in again!":
      "",
    "A newer version of Padlock is available now! Update now to keep using online features (you won't be able to sync with your account until then)!":
      "",
    "Update Now": "",
    "It seems are servers are over capacity right now. Please try again later!":
      "",
    "The data received from your online account seems to be corrupt and cannot be decrypted. This might be due to a network error but could also be the result of someone trying to compromise your connection to our servers. If the problem persists, please notify Padlock support!":
      "",
    "Please enter the master password for the online account {0}.": "",
    "Forgot Password": "",
    ...
    "It seems the data stored on Padlock Cloud was saved with a newer version of Padlock and can not be opened with the version you are currently running. Please install the latest version of Padlock on this device!":
      "",
    "Check For Updates": "",
    "Looks like we can't connect to our servers right now. Please check your internet connection and try again!":
      "",
    "Failed Connection": "",
    "Something went wrong. Please try again later!": "",
    "Congratulations, your upgrade was successful! Enjoy using Padlock!": "",
    "Payment method updated successfully!": "",
    "Subscription reactivated successfully!": "",
    "Are you sure you want to cancel your subscription? You won't be able to continue using advanced features like automatic online backups and seamless synchronization between devices!":
      "",
    "Don't Cancel": "",
    ...
    "From Clipboard": "",
    "From File": "",
    "Please choose an import method!": "",
    ...
    "Rate Padlock": "",
    "No Thanks": "",
    "Enable Auto Sync to automatically synchronize your data with your Padlock online account every time you make a change!":
      "",
    "Are you sure you want to use a custom server for synchronization? This option is only recommended for advanced users!":
      "",
    "Please enter the login code sent to you via email!": "",
    ...
    strong: "",
    "strength: {0}": "",
    "Logging in will unlock advanced features like automatic backups and seamless synchronization between all your devices!":
      "",
    ...
    "Have you backed up your data yet? Remember that by default your data is only stored locally and can not be recovered in case your device gets damaged or lost. Log in now to enable automatic online backups!":
      "",
    "Do Nothing": "",
    "The last time you synced your data with your account was {0} days ago! You should synchronize regularly to keep all your devices up-to-date and to make sure you always have a recent backup in the cloud.":
      "",
    "Synchronize Now": "",
    "Turn On Auto Sync": "",
    ...
    minutes: "",
    minute: "",
    "Padlock lets you share your data seamlessly across all your devices like phones, tablets and computers! Log in now and we'll get you set up in just few steps!":
      "",
    "Did You Know?": "",
  ...
  de: {
    "Copied To Clipboard:": "In Zwischenableage Kopiert:",
    Clear: "Löschen",
    "Generate Random Value": "Zufälligen Wert Generieren",
    length: "Länge",
    Confirm: "Bestätigen",
    "Update Payment Method": "Zahlungsmethode Ändern",
    "Upgrade to {0} now!": "Jetzt zu {0} updaten!",
    "Seamless Synchronization": "Nahtlose Synchronisation",
    "Automatic Backups": "Automatische Backups",
    "End-To-End Encryption": "End-To-End Verschlüsselung",
    "per month*": "Pro Monat*",
    "*USD, billed annually": "*USD, jährliche Abrechnung",
    "Coupon Code": "Coupon Code",
    "Please enter your credit or debit card information:":
      "Bitte geben Sie Ihre Zahlungsdaten ein!:",
    "I have a coupon!": "Ich haben einen Coupon!",
    "Contact Support": "Support Kontaktieren",
    "Secure Payment - ": "Sichere Zahlung - ",
    "Continue Trial ({0} Days Left)": "Testphase Fortsetzen ({0} Tage übrig)",
    "My Account": "Mein Account",
    "Trialing ({0} days left)": "Testphase ({0} Tage verbleibend)",
    "Upgrade Now": "Jetzt Upgraden",
    "Trial Expired": "Testphase Abgelaufen",
    "Payment Failed": "Zahlung Fehlgeschlagen",
    "Subscription Canceled": "Abonnement Beenden",
    "Reactivate Subscription": "Abonnement Reaktivieren",
    "Upgrade to enable synchronization!": "Upgraden um zu synchronisieren!",
    "{0} Devices Connected": "{0} Geräte verbunden",
    Billing: "Zahlungsdaten",
    "Cancel Subscription": "Abonnement Beenden",
    "Padlock Online": "Padlock Online",
    ...
    "Sync Automatically": "Autom. Synchronisieren",
    "Log in to enable auto sync!": "Zum freischalten einloggen!",
    "Upgrade to enable auto sync!": "Zum freischalten upgraden!",
    "Use Custom Server": "Eigenen Server Verwenden",
    "Enter Custom URL": "URL des Servers",
    ...
    Database: "Datenbank",
    "Current Location:": "Momentanter Speicherort:",
    "Change Location...": "Speicherort Ändern...",
    "Load Different Database...": "Andere Datenbank Laden...",
    Website: "Webseite",
    Support: "Hilfe",
    I: "Ich",
    ...
    "Let's get you set up! This will only take a couple of seconds.":
      "Bitte nehmen Sie sich einen kleinen Moment Zeit, um die App einzurichten.",
    "Get Started": "Starten",
    "Use Offline": "Offline Benutzen",
    "Enter Login Code": "Login-Code Eingeben",
    "Check your inbox! An email was sent to **{0}** containing your login code.":
      "Prüfen Sie Ihr Postfach! Eine Email mit Ihrem Login-Code wurde an **{0}** gesendet.",
    Cancel: "Abbrechen",
    "Please enter the master password for the account **{0}**!":
      "Bitte geben Sie das Master-Passwort für den Account **{0}** ein!",
    "I Forgot My Password": "Passwort Vergessen",
    "How do I choose a good master password?":
      "Wie wähle ich ein gutes Master Passwort?",
    "Confirm Master Password": "Master Passwort Bestätigen",
    "All done!": "Fertig!",
    "You're all set! Enjoy using Padlock!":
      "Alles ist eingerichtet! Viel Spaß beim Nutzen von Padlock!",
    "Finish Setup": "Setup Abschließen",
    "Subscr. Canceled": "Abon. Beendet",
    Synchronize: "Synchronisieren",
    "Log In To Sync": "Zum Sync. Einloggen",
    "Add Record": "Eintrag Erstellen",
    ...
    "Wrong password. Please try again!":
      "Falsches Password. Bitte versuchen Sie es erneut!",
    "For security reasons don't keep a record of your master password so unfortunately we cannot help you recover it. You can reset your password, but your data will be lost in the process!":
      "Aus Sicherheitsgründen wird Ihr Passwort nicht von uns gespeichert weshalb wir Ihnen leider nicht helfen können erneut Zugang zu Ihrer Datenbank zu gewinnen. Sie können Ihr Password zurücksetzen, aber das hat auch die Löschung Ihrer Daten zur Folge!",
    "Reset Password": "Passwort Zurücksetzen",
    "Keep Trying": "Weiter Versuchen",
    "Forgot Your Password?": "Passwort Vergessen?",
    "Are you sure you want to reset your password? WARNING: All your data will be lost!":
      "Sind Sie sicher, dass Sie Ihr Passwort zurücksetzen wollen? WARNUNG: All Ihre Daten werden gelöscht!",
    Submit: "Senden",
    "Successfully updated the password for your account {0}.":
      "Passwort für den Account {0} erfolgreich geändert.",
    "Failed to update password. Please try again later!":
      "Passwort konnte nicht geändert werden. Bitte versuchen Sie es später erneut!",
    "You successfully paired this device with Padlock Cloud!":
      "Sie haben dieses Gerät erfolgreiche mit Padlock Cloud verbunden!",
    "Synchonize Now": "Jetzt Synchronisieren",
    "Check your email! We sent your login code to {0}.":
      "Prüfen Sie Ihre Email! Wie haben Ihnen einen Login-Code an {0} gesendet.",
    "Invalid login code. Try again!":
      "Falcher Login-Code. Bitte versuchen Sie es erneut!",
    Login: "Einloggen",
    "Please enter a valid email address!":
      "Bitte geben Sie eine gültige Emailadresse ein!",
    "Log in now to unlock advanced features like automatic online backups and seamless synchronization between devices!":
      "Jetzt einloggen um weitere Features wie automatische Backups und nahtlose Synchronsierung von Geräten freizuschalten!",
    "Your trial period ends in {0} days. Upgrade now to continue using online features like synchronization and automatic backups!":
      "Ihre Testphase endet in {0} Tagen. Upgraden Sie jetzt um weiterhin Online-Funktionen wie Synchronisation und automatische Backups zu nutzen!",
    "Your free trial has expired. Upgrade now to continue using advanced features like automatic online backups and seamless synchronization between devices!":
      "Ihre kostenlose Testphase ist abgelaufen. Upgraden Sie jetzt um weiterhin Online-Funktionen wie Synchronisation und automatische Backups zu nutzen!",
    "Your last payment has failed. Please contact your card provider or update your payment method!":
      "Ihre letzte Zahlung ist fehlgeschlagen. Bitte kontaktieren Sie Ihren Anbieter oder aktualisieren Sie Ihre Zahlungsmethode!",
    "Your subscription has been canceled. Reactivate it now to continue using advanced features like automatic online backups and seamless synchronization between devices!":
      "Ihr Abonnement wurde beendet. Reaktivieren Sie es um weiterhin Online-Funktionen wie automatische Backups und nahtlose synchronisation von Geräten zu nutzen!",
    "This device is connected to the Padlock Cloud account {0}. Connect all your devices with the same account to easily synchronize your data between them!":
    ...
    "The master password you use locally does not match the one of your online account {0}. What do you want to do?":
      "Ihr lokales Master-Passwort stimmt nicht mit dem Ihres Online-Accounts {0} überein. Was wollen Sie tun?",
    "Update Local Password": "Lokales Passwort Aktualisieren",
    "Update Online Password": "Online-Passwort Aktualisieren",
    "Keep Both Passwords": "Beide Passwörter Beibelassen",
    "Local password updated successfully.":
      "Lokales Passwort erfolgreich aktualisiert.",
    "For security reasons only a limited amount of connection request are allowed at a time. Please wait a little before trying again!":
    ...
    "You've been logged out of your Padlock online account. Please login in again!":
      "Sie wurden aus Ihrem Online-Account ausgeloggt. Bitte loggen Sie sich erneut ein!",
    "A newer version of Padlock is available now! Update now to keep using online features (you won't be able to sync with your account until then)!":
      "Eine neuere Version von Padlock ist verfügbar! Updaten Sie jetzt um weiterhin Online-Funktionen zu nutzen!",
    "Update Now": "Jetzt Updaten",
    "It seems are servers are over capacity right now. Please try again later!":
      "Unsere Server scheinen gerade ausgelastet zu sein. Bitte versuchen Sie es später erneut!",
    "The data received from your online account seems to be corrupt and cannot be decrypted. This might be due to a network error but could also be the result of someone trying to compromise your connection to our servers. If the problem persists, please notify Padlock support!":
      "",
    "Please enter the master password for the online account {0}.":
      "Bitte geben Sie das Master-Passwort für den Online-Account {0} ein!",
    "Forgot Password": "Passwort Vergessen",
    "Incorrect password. Please try again!":
      "Passwort inkorrekt. Bitte versuchen Sie es erneut!",
    "It seems the data stored on Padlock Cloud was saved with a newer version of Padlock and can not be opened with the version you are currently running. Please install the latest version of Padlock on this device!":
    ...
    "Looks like we can't connect to our servers right now. Please check your internet connection and try again!":
      "Die Verbindung zu unseren Servern ist fehlgeschlagen. Bitte überprüfen Sie Ihre Internetverbindung und versuchen Sie es erneut!",
    "Failed Connection": "Verbindung Fehlgeschlagen",
    "Something went wrong. Please try again later!":
      "Es ist ein Fehler aufgetreten. Bitte versuchen Sie es später erneut!",
    "Congratulations, your upgrade was successful! Enjoy using Padlock!":
      "Glückwunsch, Ihr Upgrade wurde erfolgreich durchgeführt!",
    "Payment method updated successfully!":
      "Zahlungsmethod erfolgreich aktualisiert!",
    "Subscription reactivated successfully!":
      "Abonnement erfolgreichen reaktiviert!",
    "Are you sure you want to cancel your subscription? You won't be able to continue using advanced features like automatic online backups and seamless synchronization between devices!":
      "Sind Sie sicher dass Sie Ihr Abonnement beenden möchten? Sie verlieren Zugang zu sämtlichen Online-Funktionen!",
    "Don't Cancel": "Nicht Beenden",
    "Subscription canceled successfully.": "Abonnement erfolgreich beendet.",
    ...
    "Now choose a new master password!":
      "Wählen Sie ein neues Master Passwort aus!",
    "Enter New Password": "Neues Passwort Eingeben",
    "Confirm your new master password!": "Bestätigen Sie Ihr neues Passwort!",
    "Do you want to update the password for you online account {0} as well?":
      "Wollen Sie auch das Password für Ihren Online-Account aktualisieren?",
    Yes: "Ja",
    No: "Nein",
    "Master password changed successfully.":
    ...
    "From File": "Von Einer Datei",
    "Please choose an import method!":
      "Bitte wählen Sie eine Methode des Imports aus!",
    "Failed to open file. Did you enter the correct password?":
    ...
    "Failed to decrypt data. Did you enter the correct password?":
      "Datei konnte nicht entschlüsselt werden. Haben Sie das richtige Passwort eingegeben?",
    "No supported data found in clipboard. Please make sure to copy you data to the clipboard first (e.g. via ctrl + C).":
      "Es konnte keine für den Import unterstützten Daten in der Zwischenablage gefunden werden.",
    "This file is protected by a password.":
      "Diese Datei ist mit einem Passwort geschützt.",
    "The data you want to import seems to be in CSV format. Before you continue, please make sure that the data is structured according to Padlocks specific requirements!":
      "Die Daten die Sie importen wollen scheinen im CSV format zu sein. Bevor Sie fortfahren, stellen Sie sicher dass die Daten entsprechend Padlocks Vorraussetzungen formatiert sind!",
    ...
    "Please enter the login code sent to you via email!":
      "Bitte geben Sie den Login-Code ein, der Ihnen per Email geschickt wurde!",
    "The password you entered is weak which makes it easier for attackers to break the encryption used to protect your data. Try to use a longer password or include a variation of uppercase, lowercase and special characters as well as numbers!":
      "Das Passwort dass Sie gewählt haben ist schwach. Dies bedeutet, dass es einfacher für Angreifer ist, die Verschlüsselung zu brechen die Ihre Daten schützt. Versuchen Sie ein längeres Passwort zu verwenden sowie eine Kombination aus Groß- und Kleinbuchstaben und Sonderzeichen.",
    "Learn More": "Mehr Erfahren",
    "WARNING: Weak Password": "WARNUNG: Schwaches Passwort",
    "The password you entered does not match the original one!":
      "Das eingegebene Passwort stimmt nicht mit dem ursprünglichen überein!",
    ...
    "Logging in will unlock advanced features like automatic backups and seamless synchronization between all your devices!":
      "Indem Sie sich einloggen schalten Sie weitere Funktionen wie automatische Backups und nahtlose Synchronisation frei!",
    "Your **master password** is a single passphrase used to protect your data. Without it, nobody will be able to access your data - not even us!":
    ...
    "**Don't forget your master password!** For privacy and security reasons we never store your password anywhere which means we won't be able to help you recover your data in case you forget it. We recommend writing it down on a piece of paper and storing it somewhere safe.":
      "**Vergessen Sie Ihr Master Passwort nicht!** Aus Sicherheits- und Privatsphäregründen wird Ihr Master Passwort nirgends gespeichert. Deshalb können wir Ihnen leider nicht bei der Wiederherstellung Ihrer Daten behilflich sein, sollten Sie es jemals verlieren. Wir empfehlen, es auf einen Zettel zu schreiben und diesen an einem sicheren Ort zu verwahren.",
    "Auto-lock in 10 seconds": "Automatische Sperrung in 10 Sekunden",
    "Have you backed up your data yet? Remember that by default your data is only stored locally and can not be recovered in case your device gets damaged or lost. Log in now to enable automatic online backups!":
      "Haben Sie bereits Ihre Daten gesichert? Denken Sie daran, dass Ihren Daten standardmäßig nur offline gespeichert und können nicht wiederhergestellt werden falls Ihr Gerät beschädigt wird oder verloren geht.",
    "Do Nothing": "Nichts Tun",
    "The last time you synced your data with your account was {0} days ago! You should synchronize regularly to keep all your devices up-to-date and to make sure you always have a recent backup in the cloud.":
      "Sie haben Ihre Daten das letzte mal mit Ihren Account for {0} Tagen synchronisiert! Sie sollten Ihre Daten regelmäßig sychronisiern um all Ihre Geräte auf dem neuesten Stand zu halten und sicher zu stellen, dass Sie stets ein aktuelles Online-Backup haben!",
    ...
    minute: "Minute",
    "Padlock lets you share your data seamlessly across all your devices like phones, tablets and computers! Log in now and we'll get you set up in just few steps!":
      "Padlock erlaubt es Ihnen Ihre Daten nahtlos zwischen all Ihren Geräten zu teilen! Loggen Sie sich ein und wir helfen Ihnen, alles in wenigen Schritten einzurichten!",
