(() => {
  ...
  class App extends padlock.NotificationMixin(
    padlock.DialogMixin(padlock.BaseElement)
  ) {
    static get is() {
      return "pl-app";
    }
    ...
    constructor() {
      ...
      this._debouncedSynchronize = padlock.util.debounce(
