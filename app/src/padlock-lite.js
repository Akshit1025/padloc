  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      ...
      2: [
        ...
        { "./ajax": 1, "./platform": 3, "./tracking": 4, "./util": 5 }
      ],
      3: [
        function (require, module, exports) {
          "use strict";
          ...
          const cordovaReady = new Promise((r) =>
          ...
          function getPlatformName() {
            return __awaiter(this, void 0, void 0, function* () {
              if (isElectron()) {
                ...
                const info = yield new Promise((r) =>
      ...
      4: [
        function (require, module, exports) {
          ...
          let ready = initialized
            .then(() =>
              Promise.all([statsApi.get(), platform_1.getAppVersion()])
            )
            .then(([stats, version]) => {
              trackingID = stats.trackingID;
              const launchCount =
                typeof stats.launchCount === "number"
                  ? stats.launchCount + 1
                  : 1;
            ...
            ready = ready
              ...
              .then((stats) => {
                ...
                if (stats.lastReviewed) {
                  data.props["Last Reviewed"] = new Date(
                    stats.lastReviewed
                  ).toISOString();
                }
              })
      ...
      5: [
        function (require, module, exports) {
          ...
          function formatDateUntil(startDate, duration) {
            const d = moment.duration(
              moment(startDate).add(duration, "hours").diff(moment())
            );
        ...
        { moment: 7, "moment-duration-format": 6 }
      ],
      6: [
        function (require, module, exports) {
          ...
          (function (root, factory) {
            ...
            function formatNumber(number, options, userLocale) {
              ...
              if (useToLocaleString && userLocale) {
                ...
                if (maximumSignificantDigits && number > 0) {
                  localeStringOptions.maximumSignificantDigits =
                    maximumSignificantDigits;
                }
                ...
                if (!toLocaleStringRoundingWorks) {
                  ...
                  number = parseFloat(
                    formatNumber(number, roundingOptions),
                    10
                  );
                }
              ...
              if (
                ...
                (!maximumSignificantDigits &&
                  fractionLength === fractionDigits + 1)
              ) {
                // Round digits.
              ...
              if (exponent > 0) {
                if (fractionString.length <= exponent) {
                  fractionString =
                    fractionString +
                    repeatZero(exponent - fractionString.length);

                  integerString = integerString + fractionString;
                  fractionString = "";
                } else {
                  integerString =
                    integerString + fractionString.slice(0, exponent);
            ...
            function featureTestToLocaleString() {
              ...
              passed =
                passed &&
                (1).toLocaleString("en", { minimumIntegerDigits: 1 }) === "1";
              passed =
                passed &&
                (1).toLocaleString("en", { minimumIntegerDigits: 2 }) === "01";
              passed =
                passed &&
                (1).toLocaleString("en", { minimumIntegerDigits: 3 }) === "001";
              if (!passed) {
                return false;
              }
              ...
              passed =
                passed &&
                (1000).toLocaleString("en", { useGrouping: true }) === "1,000";
              passed =
                passed &&
                (1000).toLocaleString("en", { useGrouping: false }) === "1000";
              if (!passed) {
                return false;
              }
            ...
            function durationFormat() {
              ...
              var remainderMonths = moment.duration(
                Math.abs(asMonths),
                "months"
              );
              ...
              var significantDigits = useSignificantDigits
                ? settings.precision
                : 0;
              ...
              if (
                trim === null &&
                (largest || maxValue || useSignificantDigits)
              ) {
                trim = "all";
              }
              ...
              var formatValue = function (momentType, index) {
                ...
                if (momentType.tokenLength > 1 && (forceLength || foundFirst)) {
                  ...
                  if (
                    bubbled &&
                    formatOptions.maximumSignificantDigits <
                      momentType.tokenLength
                  ) {
              ...
              each(tokens, function (token) {
                ...
                each(localeData._durationLabelTypes, function (labelType) {
                  var label = find(labels, function (label) {
                    return (
                      label.type === labelType.type && label.key === pluralKey
                    );
                  });
              ...
              tokens = map(tokens, function (token) {
                ...
                if (
                  token.type === "milliseconds" &&
                  momentType.formattedValueMS
                ) {
            ...
            toLocaleStringRoundingWorks =
              toLocaleStringWorks && featureTestToLocaleStringRounding();
